...
namespace BellumGens.Api.Providers
{
	public static class NotificationsService
	{
		...
		public static void SendNotification(BellumGensPushSubscription sub, TeamInvite notification, NotificationState state)
		{
			var subject = @"https://bellumgens.com";
		...
		public static void SendNotification(BellumGensPushSubscription sub, TeamApplication notification)
		{
			var subject = @"https://bellumgens.com";
		...
		public static void SendNotification(BellumGensPushSubscription sub, TeamApplication notification, NotificationState state)
		{
			var subject = @"https://bellumgens.com";
